...
namespace FisSst.BlazorMaps
{
    ...
    public abstract class Layer : Evented
    {
        ...
        public async Task<Layer> BindPopup(string content)
        {
            ...
            await this.JsReference.InvokeAsync<IJSObjectReference>(BindPopupJsFunction, content, options);
            return this;
        }
        ...
        public async Task<Layer> BindTooltip(string content)
        {
            ...
            await this.JsReference.InvokeAsync<IJSObjectReference>(BindTooltipJsFunction, content, options);
            return this;
        }
