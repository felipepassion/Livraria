...
namespace Niu.Nutri.Users.Domain.Aggregates.UsersAgg.Profiles
{
	...
	public partial class UsersAggProfile : Profile
	{
		public UsersAggProfile()
		{
			...
			CreateMap<UserContactNumberDTO, UserContactNumber>()
				.ForMember(x=>x.ExternalId, opt => opt.MapFrom(x=>x.ExternalId ?? Guid.NewGuid().ToString()));
			CreateMap<UserContactNumber, UserContactNumberDTO>();
...
namespace Niu.Nutri.Users.Domain.Aggregates.SystemSettingsAgg.Profiles
{
