...
namespace Niu.Nutri.Users.Domain.Aggregates.UsersAgg.CommandHandlers
{
        ...
        IRequestHandler<DeactiveUserProfileAccessCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateUserProfileAccessCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_userProfileAccessRepository.UnitOfWork, entity.ProjectedAs<UserProfileAccessDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeUserProfileAccessCommand command,CancellationToken cancellationToken) {
            ...
            {
                var entity = command.Entity as UserProfileAccess ?? await _userProfileAccessRepository.FindAsync(UserProfileAccessFilters.GetFilters(item.Key));
            ...
            return await Commit(_userProfileAccessRepository.UnitOfWork, command.Entity.ProjectedAs<UserProfileAccessDTO>());
        }
        ...
        IRequestHandler<DeactiveUserCurrentAccessSelectedCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateUserCurrentAccessSelectedCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_userCurrentAccessSelectedRepository.UnitOfWork, entity.ProjectedAs<UserCurrentAccessSelectedDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeUserCurrentAccessSelectedCommand command,CancellationToken cancellationToken) {
            ...
            foreach (var item in command.Query)
            {
                var entity = command.Entity as UserCurrentAccessSelected ?? await _userCurrentAccessSelectedRepository.FindAsync(UserCurrentAccessSelectedFilters.GetFilters(item.Key));
            ...
            return await Commit(_userCurrentAccessSelectedRepository.UnitOfWork, command.Entity.ProjectedAs<UserCurrentAccessSelectedDTO>());
        }
        ...
        IRequestHandler<DeactiveUserProfileListCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateUserProfileListCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_userProfileListRepository.UnitOfWork, entity.ProjectedAs<UserProfileListDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeUserProfileListCommand command,CancellationToken cancellationToken) {
            ...
            foreach (var item in command.Query)
            {
                var entity = command.Entity as UserProfileList ?? await _userProfileListRepository.FindAsync(UserProfileListFilters.GetFilters(item.Key));
            ...
            return await Commit(_userProfileListRepository.UnitOfWork, command.Entity.ProjectedAs<UserProfileListDTO>());
        }
        ...
        IRequestHandler<DeactiveUserProfileCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateUserProfileCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_userProfileRepository.UnitOfWork, entity.ProjectedAs<UserProfileDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeUserProfileCommand command,CancellationToken cancellationToken) {
            ...
            foreach (var item in command.Query)
            {
                var entity = command.Entity as UserProfile ?? await _userProfileRepository.FindAsync(UserProfileFilters.GetFilters(item.Key));
            ...
            return await Commit(_userProfileRepository.UnitOfWork, command.Entity.ProjectedAs<UserProfileDTO>());
        }
        ...
        IRequestHandler<DeactiveUsersAggSettingsCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateUsersAggSettingsCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_usersAggSettingsRepository.UnitOfWork, entity.ProjectedAs<UsersAggSettingsDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeUsersAggSettingsCommand command,CancellationToken cancellationToken) {
            ...
            foreach (var item in command.Query)
            {
                var entity = command.Entity as UsersAggSettings ?? await _usersAggSettingsRepository.FindAsync(UsersAggSettingsFilters.GetFilters(item.Key));
            ...
            return await Commit(_usersAggSettingsRepository.UnitOfWork, command.Entity.ProjectedAs<UsersAggSettingsDTO>());
        }
        ...
        IRequestHandler<DeactiveUserCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateUserCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_userRepository.UnitOfWork, entity.ProjectedAs<UserDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeUserCommand command,CancellationToken cancellationToken) {
            ...
            foreach (var item in command.Query)
            {
                var entity = command.Entity as User ?? await _userRepository.FindAsync(UserFilters.GetFilters(item.Key));
            ...
            return await Commit(_userRepository.UnitOfWork, command.Entity.ProjectedAs<UserDTO>());
        }
