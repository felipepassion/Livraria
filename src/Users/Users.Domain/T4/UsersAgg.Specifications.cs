...
namespace Niu.Nutri.Users.Domain.Aggregates.UsersAgg.Specifications {
	using Entities;
   public partial class UserProfileAccessSpecifications {
		...
		public static Specification<UserProfileAccess> DescriptionNotContains(string value) {
			return new DirectSpecification<UserProfileAccess>(p => !EF.Functions.Like(p.Description.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<UserProfileAccess> DescriptionEqual(string value) {
			return new DirectSpecification<UserProfileAccess>(p => value.ToLower() == (p.Description.ToLower()));
		}
		...
		public static Specification<UserProfileAccess> ExternalIdNotContains(string value) {
			return new DirectSpecification<UserProfileAccess>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<UserProfileAccess> ExternalIdEqual(string value) {
			return new DirectSpecification<UserProfileAccess>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
   ...
   public partial class UserCurrentAccessSelectedSpecifications {
		...
		public static Specification<UserCurrentAccessSelected> ExternalIdNotContains(string value) {
			return new DirectSpecification<UserCurrentAccessSelected>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<UserCurrentAccessSelected> ExternalIdEqual(string value) {
			return new DirectSpecification<UserCurrentAccessSelected>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
   ...
   public partial class UserProfileListSpecifications {
		...
		public static Specification<UserProfileList> ExternalIdNotContains(string value) {
			return new DirectSpecification<UserProfileList>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<UserProfileList> ExternalIdEqual(string value) {
			return new DirectSpecification<UserProfileList>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
   ...
   public partial class UserProfileSpecifications {
		...
		public static Specification<UserProfile> DescriptionNotContains(string value) {
			return new DirectSpecification<UserProfile>(p => !EF.Functions.Like(p.Description.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<UserProfile> DescriptionEqual(string value) {
			return new DirectSpecification<UserProfile>(p => value.ToLower() == (p.Description.ToLower()));
		}
		...
		public static Specification<UserProfile> CodeNotContains(string value) {
			return new DirectSpecification<UserProfile>(p => !EF.Functions.Like(p.Code.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<UserProfile> CodeEqual(string value) {
			return new DirectSpecification<UserProfile>(p => value.ToLower() == (p.Code.ToLower()));
		}
		...
		public static Specification<UserProfile> InitialPageNotContains(string value) {
			return new DirectSpecification<UserProfile>(p => !EF.Functions.Like(p.InitialPage.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<UserProfile> InitialPageEqual(string value) {
			return new DirectSpecification<UserProfile>(p => value.ToLower() == (p.InitialPage.ToLower()));
		}
		...
		public static Specification<UserProfile> InitialPageIsNotNull() {
			...
			return new DirectSpecification<UserProfile>(p => p.IsPrivateProfile == value);
					...
					public static Specification<UserProfile> ShowSideBarEqual(bool value) {
			return new DirectSpecification<UserProfile>(p => p.ShowSideBar == value);
		}
		...
		public static Specification<UserProfile> ExternalIdNotContains(string value) {
			return new DirectSpecification<UserProfile>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<UserProfile> ExternalIdEqual(string value) {
			return new DirectSpecification<UserProfile>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
   ...
   public partial class UsersAggSettingsSpecifications {
		...
		public static Specification<UsersAggSettings> ExternalIdNotContains(string value) {
			return new DirectSpecification<UsersAggSettings>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<UsersAggSettings> ExternalIdEqual(string value) {
			return new DirectSpecification<UsersAggSettings>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
   ...
   public partial class UserSpecifications {
        ...
        public static Specification<User> BirthDateLessThan(System.DateOnly value) {
            return new DirectSpecification<User>(p => p.BirthDate < value);
					...
					public static Specification<User> GenderEqual(params Niu.Nutri.Users.Enumerations.GenderEnum[] values) {
			return new DirectSpecification<User>(p => values.Contains(p.Gender));
		}
		public static Specification<User> GenderNotEqual(Niu.Nutri.Users.Enumerations.GenderEnum value) {
		...
		public static Specification<User> ProfilePictureNotContains(string value) {
			return new DirectSpecification<User>(p => !EF.Functions.Like(p.ProfilePicture.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<User> ProfilePictureEqual(string value) {
			return new DirectSpecification<User>(p => value.ToLower() == (p.ProfilePicture.ToLower()));
		}
