...
namespace Niu.Nutri.Users.Infra.Data.Aggregates.UsersAgg.Mappings
{
    ...
    public partial class UserMapping : IEntityTypeConfiguration<User>
    {
        partial void ConfigureAdditionalMapping(EntityTypeBuilder<User> builder)
        {
            ...
            builder.HasOne<ApplicationUser>().WithOne().HasForeignKey<ApplicationUser>(x => x.Id);
    ...
    public partial class UserCurrentAccessSelectedMapping : IEntityTypeConfiguration<UserCurrentAccessSelected>
    {
        ...
        {
            builder.HasOne<UserProfile>().WithMany().HasForeignKey(x => x.UserProfileId);
        }
    }
...
namespace Niu.Nutri.Users.Infra.Data.Aggregates.IdentityAgg.Mappings
{
