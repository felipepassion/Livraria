...
using Niu.Nutri.Users.Infra.Data.Aggregates.UsersAgg.Mappings; 
using Niu.Nutri.Users.Domain.Aggregates.SystemSettingsAgg.Entities; 
using Niu.Nutri.Users.Infra.Data.Aggregates.SystemSettingsAgg.Mappings; 
...
namespace Niu.Nutri.Users.Infra.Data.Context
{
	public partial class UsersAggContext : BaseContext
	{
		...
		public DbSet<UserContactNumber> UserContactNumber { get; set; }
		...
		protected override void OnModelCreating(ModelBuilder builder)
		{
			...
			builder.ApplyConfiguration(new UserContactNumberMapping());
