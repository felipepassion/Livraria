...
namespace Niu.Nutri.Users.Infra.Data.Aggregates.UsersAgg.Mappings 
{
    ...
    public partial class UserContactNumberMapping : IEntityTypeConfiguration<UserContactNumber>
    {
        public void Configure(EntityTypeBuilder<UserContactNumber> builder)
        {
            builder.HasKey(x => x.Id);
            ConfigureAdditionalMapping(builder);
        }

		partial void ConfigureAdditionalMapping(EntityTypeBuilder<UserContactNumber> builder);
    }
