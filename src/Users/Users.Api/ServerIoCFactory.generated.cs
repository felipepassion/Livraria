...
namespace Niu.Nutri.Users.Api {
    ...
    public static partial class IoCFactory {
		...
		public static void InjectDependencies(this IServiceCollection services, IConfiguration configuration) {
            ...
            Niu.Nutri.Users.Infra.IoC.IoCFactory.Current.Configure(configuration, services);
        ...
        public static void OnAppInitialized(this WebApplication app)
        {
            using (var scope = app.Services.CreateScope())
            {
                ...
                logProvider.Write(new Niu.Nutri.CrossCutting.Infra.Log.Entries.LogEntry("------> APP | Users.Api | STARTED <------", action: "OnAppInitialized"));
            }
        }
    }
}