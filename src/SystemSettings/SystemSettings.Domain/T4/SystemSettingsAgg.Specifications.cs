...
namespace Niu.Nutri.SystemSettings.Domain.Aggregates.SystemSettingsAgg.Specifications {
	using Entities;
   public partial class SystemPanelSubItemSpecifications {
        ...
        public static Specification<SystemPanelSubItem> SystemPanelIdLessThan(int value) {
			...
			return new DirectSpecification<SystemPanelSubItem>(p => p.IsSubItem == value);
					...
					public static Specification<SystemPanelSubItem> PositionContains(params int[] values) {
            return new DirectSpecification<SystemPanelSubItem>(p => values.Contains(p.Position));
        }
		public static Specification<SystemPanelSubItem> PositionNotContains(params int[] values) {
            return new DirectSpecification<SystemPanelSubItem>(p => !values.Contains(p.Position));
        }
		public static Specification<SystemPanelSubItem> PositionEqual(params int[] values) {
			return new DirectSpecification<SystemPanelSubItem>(p => values.Contains(p.Position));
        }
        public static Specification<SystemPanelSubItem> PositionGreaterThanOrEqual(int value) {
            return new DirectSpecification<SystemPanelSubItem>(p => p.Position >= value);
        }
        public static Specification<SystemPanelSubItem> PositionLessThanOrEqual(int value) {
            return new DirectSpecification<SystemPanelSubItem>(p => p.Position <= value);
        }
        public static Specification<SystemPanelSubItem> PositionNotEqual(int value) {
            return new DirectSpecification<SystemPanelSubItem>(p => p.Position != value);
        }
        public static Specification<SystemPanelSubItem> PositionGreaterThan(int value) {
            return new DirectSpecification<SystemPanelSubItem>(p => p.Position > value);
        }
        public static Specification<SystemPanelSubItem> PositionLessThan(int value) {
            return new DirectSpecification<SystemPanelSubItem>(p => p.Position < value);
        }
		...
		public static Specification<SystemPanelSubItem> IconNotContains(string value) {
			return new DirectSpecification<SystemPanelSubItem>(p => !EF.Functions.Like(p.Icon.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanelSubItem> IconEqual(string value) {
			return new DirectSpecification<SystemPanelSubItem>(p => value.ToLower() == (p.Icon.ToLower()));
		}
		...
		public static Specification<SystemPanelSubItem> DescriptionNotContains(string value) {
			return new DirectSpecification<SystemPanelSubItem>(p => !EF.Functions.Like(p.Description.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanelSubItem> DescriptionEqual(string value) {
			return new DirectSpecification<SystemPanelSubItem>(p => value.ToLower() == (p.Description.ToLower()));
		}
		...
		public static Specification<SystemPanelSubItem> UrlNotContains(string value) {
			return new DirectSpecification<SystemPanelSubItem>(p => !EF.Functions.Like(p.Url.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanelSubItem> UrlEqual(string value) {
			return new DirectSpecification<SystemPanelSubItem>(p => value.ToLower() == (p.Url.ToLower()));
		}
		...
		public static Specification<SystemPanelSubItem> ExternalIdNotContains(string value) {
			return new DirectSpecification<SystemPanelSubItem>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanelSubItem> ExternalIdEqual(string value) {
			return new DirectSpecification<SystemPanelSubItem>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
   ...
   public partial class SystemPanelSpecifications {
		...
		public static Specification<SystemPanel> IconNotContains(string value) {
			return new DirectSpecification<SystemPanel>(p => !EF.Functions.Like(p.Icon.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanel> IconEqual(string value) {
			return new DirectSpecification<SystemPanel>(p => value.ToLower() == (p.Icon.ToLower()));
		}
		...
		public static Specification<SystemPanel> DescriptionNotContains(string value) {
			return new DirectSpecification<SystemPanel>(p => !EF.Functions.Like(p.Description.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanel> DescriptionEqual(string value) {
			return new DirectSpecification<SystemPanel>(p => value.ToLower() == (p.Description.ToLower()));
		}
		...
		public static Specification<SystemPanel> DescriptionIsNotNull() {
            return new DirectSpecification<SystemPanel>(p => p.Description != null);
					...
					public static Specification<SystemPanel> CodeContains(string value) {
			return new DirectSpecification<SystemPanel>(p => EF.Functions.Like(p.Code.ToLower(), $"%{value.ToLower()}%"));
		}
		public static Specification<SystemPanel> CodeNotContains(string value) {
			return new DirectSpecification<SystemPanel>(p => !EF.Functions.Like(p.Code.ToLower(), $"%{value.ToLower()}%"));
		}
		public static Specification<SystemPanel> CodeStartsWith(string value) {
			return new DirectSpecification<SystemPanel>(p => EF.Functions.Like(p.Code.ToLower(), $"{value.ToLower()}%"));
		}
	
		public static Specification<SystemPanel> CodeEqual(string value) {
			return new DirectSpecification<SystemPanel>(p => value.ToLower() == (p.Code.ToLower()));
		}
		public static Specification<SystemPanel> CodeNotEqual(string value) {
			return new DirectSpecification<SystemPanel>(p => p.Code != value);
		}
		public static Specification<SystemPanel> CodeIsNull() {
            return new DirectSpecification<SystemPanel>(p => p.Code == null);
        }
		public static Specification<SystemPanel> CodeIsNotNull() {
            return new DirectSpecification<SystemPanel>(p => p.Code != null);
        }
		...
		public static Specification<SystemPanel> ExternalIdNotContains(string value) {
			return new DirectSpecification<SystemPanel>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanel> ExternalIdEqual(string value) {
			return new DirectSpecification<SystemPanel>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
   ...
   public partial class SystemPanelGroupSpecifications {
		...
		public static Specification<SystemPanelGroup> IconNotContains(string value) {
			return new DirectSpecification<SystemPanelGroup>(p => !EF.Functions.Like(p.Icon.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanelGroup> IconEqual(string value) {
			return new DirectSpecification<SystemPanelGroup>(p => value.ToLower() == (p.Icon.ToLower()));
		}
		...
		public static Specification<SystemPanelGroup> DescriptionNotContains(string value) {
			return new DirectSpecification<SystemPanelGroup>(p => !EF.Functions.Like(p.Description.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanelGroup> DescriptionEqual(string value) {
			return new DirectSpecification<SystemPanelGroup>(p => value.ToLower() == (p.Description.ToLower()));
		}
		...
		public static Specification<SystemPanelGroup> CodeNotContains(string value) {
			return new DirectSpecification<SystemPanelGroup>(p => !EF.Functions.Like(p.Code.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanelGroup> CodeEqual(string value) {
			return new DirectSpecification<SystemPanelGroup>(p => value.ToLower() == (p.Code.ToLower()));
		}
		...
		public static Specification<SystemPanelGroup> CodeIsNotNull() {
            return new DirectSpecification<SystemPanelGroup>(p => p.Code != null);
					...
					public static Specification<SystemPanelGroup> IsPrivateEqual(bool value) {
			return new DirectSpecification<SystemPanelGroup>(p => p.IsPrivate == value);
		}
		...
		public static Specification<SystemPanelGroup> ExternalIdNotContains(string value) {
			return new DirectSpecification<SystemPanelGroup>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemPanelGroup> ExternalIdEqual(string value) {
			return new DirectSpecification<SystemPanelGroup>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
   ...
   public partial class CargaTabelaSpecifications {
		...
		public static Specification<CargaTabela> TableNameNotContains(string value) {
			return new DirectSpecification<CargaTabela>(p => !EF.Functions.Like(p.TableName.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<CargaTabela> TableNameEqual(string value) {
			return new DirectSpecification<CargaTabela>(p => value.ToLower() == (p.TableName.ToLower()));
		}
		...
		public static Specification<CargaTabela> FilePathNotContains(string value) {
			return new DirectSpecification<CargaTabela>(p => !EF.Functions.Like(p.FilePath.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<CargaTabela> FilePathEqual(string value) {
			return new DirectSpecification<CargaTabela>(p => value.ToLower() == (p.FilePath.ToLower()));
		}
		...
		public static Specification<CargaTabela> ExternalIdNotContains(string value) {
			return new DirectSpecification<CargaTabela>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<CargaTabela> ExternalIdEqual(string value) {
			return new DirectSpecification<CargaTabela>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
   ...
   public partial class SystemSettingsAggSettingsSpecifications {
		...
		public static Specification<SystemSettingsAggSettings> ExternalIdNotContains(string value) {
			return new DirectSpecification<SystemSettingsAggSettings>(p => !EF.Functions.Like(p.ExternalId.ToLower(), $"%{value.ToLower()}%"));
		}
		...
		public static Specification<SystemSettingsAggSettings> ExternalIdEqual(string value) {
			return new DirectSpecification<SystemSettingsAggSettings>(p => value.ToLower() == (p.ExternalId.ToLower()));
		}
