...
namespace Niu.Nutri.SystemSettings.Domain.Aggregates.SystemSettingsAgg.CommandHandlers
{
        ...
        IRequestHandler<DeactiveSystemPanelSubItemCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateSystemPanelSubItemCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_systemPanelSubItemRepository.UnitOfWork, entity.ProjectedAs<SystemPanelSubItemDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeSystemPanelSubItemCommand command,CancellationToken cancellationToken) {
            ...
            {
                var entity = command.Entity as SystemPanelSubItem ?? await _systemPanelSubItemRepository.FindAsync(SystemPanelSubItemFilters.GetFilters(item.Key));
            ...
            return await Commit(_systemPanelSubItemRepository.UnitOfWork, command.Entity.ProjectedAs<SystemPanelSubItemDTO>());
        }
        ...
        IRequestHandler<DeactiveSystemPanelCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateSystemPanelCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_systemPanelRepository.UnitOfWork, entity.ProjectedAs<SystemPanelDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeSystemPanelCommand command,CancellationToken cancellationToken) {
            ...
            foreach (var item in command.Query)
            {
                var entity = command.Entity as SystemPanel ?? await _systemPanelRepository.FindAsync(SystemPanelFilters.GetFilters(item.Key));
            ...
            return await Commit(_systemPanelRepository.UnitOfWork, command.Entity.ProjectedAs<SystemPanelDTO>());
        }
        ...
        IRequestHandler<DeactiveSystemPanelGroupCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateSystemPanelGroupCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_systemPanelGroupRepository.UnitOfWork, entity.ProjectedAs<SystemPanelGroupDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeSystemPanelGroupCommand command,CancellationToken cancellationToken) {
            ...
            foreach (var item in command.Query)
            {
                var entity = command.Entity as SystemPanelGroup ?? await _systemPanelGroupRepository.FindAsync(SystemPanelGroupFilters.GetFilters(item.Key));
            ...
            return await Commit(_systemPanelGroupRepository.UnitOfWork, command.Entity.ProjectedAs<SystemPanelGroupDTO>());
        }
        ...
        IRequestHandler<DeactiveCargaTabelaCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateCargaTabelaCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_cargaTabelaRepository.UnitOfWork, entity.ProjectedAs<CargaTabelaDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeCargaTabelaCommand command,CancellationToken cancellationToken) {
            ...
            foreach (var item in command.Query)
            {
                var entity = command.Entity as CargaTabela ?? await _cargaTabelaRepository.FindAsync(CargaTabelaFilters.GetFilters(item.Key));
            ...
            return await Commit(_cargaTabelaRepository.UnitOfWork, command.Entity.ProjectedAs<CargaTabelaDTO>());
        }
        ...
        IRequestHandler<DeactiveSystemSettingsAggSettingsCommand,DomainResponse>
    {
        ...
        public async Task<DomainResponse> Handle(CreateSystemSettingsAggSettingsCommand command,CancellationToken cancellationToken) {
            ...
            return await Commit(_systemSettingsAggSettingsRepository.UnitOfWork, entity.ProjectedAs<SystemSettingsAggSettingsDTO>());
        }
        ...
        public async Task<DomainResponse> Handle(UpdateRangeSystemSettingsAggSettingsCommand command,CancellationToken cancellationToken) {
            ...
            foreach (var item in command.Query)
            {
                var entity = command.Entity as SystemSettingsAggSettings ?? await _systemSettingsAggSettingsRepository.FindAsync(SystemSettingsAggSettingsFilters.GetFilters(item.Key));
            ...
            return await Commit(_systemSettingsAggSettingsRepository.UnitOfWork, command.Entity.ProjectedAs<SystemSettingsAggSettingsDTO>());
        }
